...
const updateTask = () => {
    ...
    const updatedTask = { ...task.value,dueDate:formattedDueDate, user: { id: selectedUser.value }
    }
    ...
    <main>
        <Navbar />
         <div class="container px-4 py-5 px-md-5 text-center text-lg-start my-5">
                    ...
                    <h2 class="mt-3 display-5 fw-bold ls-tight text-center" style="color: hsl(218, 81%, 75%)">Update Todo List</h2>
